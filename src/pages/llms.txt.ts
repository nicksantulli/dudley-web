...
- Last Human: A free satirical top-down arcade game for iPhone — you're the last human in an AI-automated office, dodging AutoBots to reach the time clock before your position gets deprecated. Free, no in-app purchases. Non-personalized ads between levels only. iOS. Launching on the App Store soon.
