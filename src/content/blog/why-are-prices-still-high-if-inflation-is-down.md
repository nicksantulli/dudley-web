---
title: "Why Are Prices Still High If Inflation Is Down?"
description: "Inflation going down usually means prices are rising more slowly, not that the grocery bill has gone back to its old level. Here is the plain-English difference."
...
tags:
  ...
  - "disinflation"
  - "EconByte"
primaryKeyword: "why are prices still high if inflation is down"
relatedApps:
  - "econbyte"
faq:
  - q: "Why are prices still high if inflation is down?"
    a: "Because lower inflation usually means prices are rising more slowly, not that the overall price level is falling. Prices broadly fall only when inflation turns negative, which economists call deflation."
  - q: "What is the difference between inflation and prices?"
    a: "Prices are the dollar amounts you see on individual items. The price level is the average cost of a basket of goods and services. Inflation is the rate at which that average price level rises."
  - q: "Did grocery prices fall in August 2026?"
    a: "The BLS reported that the food-at-home index was unchanged in August 2026, but it was still 2.2 percent higher than a year earlier. That means groceries stopped rising that month on average, not that they returned to older prices."
  - q: "What is disinflation?"
    a: "Disinflation means the inflation rate slows while remaining positive. Prices are still increasing overall, just at a slower pace than before."
  - q: "Is EconByte financial advice?"
    a: "No. EconByte is an economics education app for iPhone. It explains concepts like inflation, interest rates, GDP, and trade in plain language, but it is not financial or investment advice."
draft: false
---
...
| Measure | August monthly change | 12-month change |
|---|---:|---:|
| All items CPI-U | 0.4% | 3.4% |
| Food | 0.1% | 2.7% |
| Food at home | 0.0% | 2.2% |
